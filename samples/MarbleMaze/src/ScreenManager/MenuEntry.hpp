...
// sample, vanilla "GameStateManagement" library). By default this just draws
// the entry text string (yellow when selected, white otherwise, gently
// pulsating in scale) -- unlike HoneycombRush's customized copy in this repo,
// there is no button-background texture here.

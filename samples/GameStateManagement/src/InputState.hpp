...
// Helper for reading input from keyboard and gamepad. Tracks both the current
// and previous state and implements high-level query methods such as "move up
// through the menu" or "pause the game". (Touch/gestures from the XNA original
// are omitted on desktop — see missing.md.)
class InputState {
public:

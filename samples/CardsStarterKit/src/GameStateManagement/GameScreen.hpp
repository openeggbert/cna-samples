...
// CardsStarterKit sample). Same "Game State Management" template already
// ported for GameStateManagement/NinjAcademy -- ported again here,
// self-contained, per this repo's "no shared samples/common/ library" rule.
...
public:
    ...
    // Helper that loads assets using the screen manager's associated game
    // content loader. Defined out-of-line in ScreenManager.hpp.
    template <typename T>

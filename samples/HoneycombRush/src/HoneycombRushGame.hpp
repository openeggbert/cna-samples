...
// HoneycombRushGame.hpp — C++ port of HoneycombRush.cs (XNA 4.0 HoneycombRush
// sample's main Game class). Skips forcing fullscreen, matching this
// project's DynamicMenu/UISample precedent — see missing.md.
...
// Main game class. Port of HoneycombRush.cs.
class HoneycombRushGame : public Game {
public:
    HoneycombRushGame() : graphics_(this) {
    ...
    const std::string& GetTypeName() const override {
        static const std::string name = "HoneycombRushGame";
        return name;
    }
...
protected:
    ...
    void LoadContent() override {
        ...
        // Draw() below) -- matching this project's established UISample
        // precedent for a component-driven ScreenManager architecture.
